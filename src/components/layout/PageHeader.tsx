...
export function PageHeader({ title, subtitle, children }: PageHeaderProps) {
  return (
    <div className="flex items-center justify-between gap-3 px-4 py-3.5 sm:px-6 sm:py-4 md:px-8 md:py-5 bg-[var(--card)] dark:bg-[var(--secondary)] border-b border-[var(--border)] flex-wrap">
